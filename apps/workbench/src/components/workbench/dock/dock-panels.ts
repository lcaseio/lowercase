...
export type OpenPanelRequest =
  ...
  | {
      ...
      // would silently no-op. See PR 28 in docs/initiatives/ui-workspace/INITIATIVE.md.
      revealPath?: string[];
      revealAt?: number;
    }
  | {
      ...
      // PR 19 in docs/initiatives/ui-workspace/INITIATIVE.md for why this is a real
