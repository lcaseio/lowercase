# Prove Swappable Infrastructure Initiative — Arc: SQL Adapter (Changes C14–C15)

**Previous:** [`work-tracking-migration.md`](./work-tracking-migration.md) (Change C6) · **Related:** [`queue-adapter.md`](./queue-adapter.md) (Changes C4–C5, C7–C9, C11–C13), [`package-tooling.md`](./package-tooling.md) (Change C10)
...
## Change C14 - Postgres adapter (Prisma) - not started
...
## Change C15 - Extend the `local-system` profile with the `postgres` SQL branch - not started
