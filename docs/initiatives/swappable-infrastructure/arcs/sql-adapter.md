# Prove Swappable Infrastructure Initiative — Arc: SQL Adapter (Changes C10–C11)

**Previous:** [`queue-adapter.md`](./queue-adapter.md) (Changes C4–C9)
...
## Change C10 - Postgres adapter (Prisma) - not started
...
## Change C11 - Extend the `local-system` profile with the `postgres` SQL branch - not started
