# Prove Swappable Infrastructure Initiative — Arc: SQL Adapter (Changes C11–C12)

**Previous:** [`work-tracking-migration.md`](./work-tracking-migration.md) (Change C6) · **Related:** [`queue-adapter.md`](./queue-adapter.md) (Changes C4–C5, C7–C10)
...
## Change C11 - Postgres adapter (Prisma) - not started
...
## Change C12 - Extend the `local-system` profile with the `postgres` SQL branch - not started
