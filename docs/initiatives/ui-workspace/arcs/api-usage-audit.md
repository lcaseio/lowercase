...
Part of the [`INITIATIVE.md`](../INITIATIVE.md) PR log. Follows directly from PR 51 (`arcs/api-reference-docs.md`) — having the real API surface written down first is what makes this audit possible at all.
