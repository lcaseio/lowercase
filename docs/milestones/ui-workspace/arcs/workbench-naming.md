...
## PR 48 - `flow-graph-panel` internal split + `shared/flow-graph/` kit + its two authoring panels - ready for review
...
PR 47 merged (#330). PR 48 ready for review — full tree above matches what's actually on disk.
