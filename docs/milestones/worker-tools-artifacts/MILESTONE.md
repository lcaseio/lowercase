...
| 4   | Legacy compatibility adapter — connects Worker V2 to the current engine unchanged         | merged (#353) | [`arcs/worker-v2-build.md`](./arcs/worker-v2-build.md)           | [Worker V2 plan — Phase 3](../../component-architecture/worker-v2/README.md#phase-3-legacy-compatibility-adapter) |
