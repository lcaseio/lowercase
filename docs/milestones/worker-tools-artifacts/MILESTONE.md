...
| 2   | Worker V2 core contract + fake collaborators, no runtime wiring                           | in progress   | [`arcs/worker-v2-build.md`](./arcs/worker-v2-build.md)           | [Worker V2 plan — Phase 1](../../component-architecture/worker-v2/README.md#phase-1-core-contract-and-tests)      |
