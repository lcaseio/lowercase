# Prove Swappable Infrastructure Milestone — Arc: SQL Adapter (PRs 6–7)

**Previous:** [`queue-adapter.md`](./queue-adapter.md) (PRs 4–5)
...
## PR 6 - Postgres adapter (Prisma) - not started
...
## PR 7 - Extend the `local-system` profile with the `postgres` SQL branch - not started
