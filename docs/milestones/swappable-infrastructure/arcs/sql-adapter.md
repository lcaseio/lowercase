# Prove Swappable Infrastructure Milestone — Arc: SQL Adapter (PRs 5–6)

**Previous:** [`queue-adapter.md`](./queue-adapter.md) (PRs 3–4)
...
## PR 5 - Postgres adapter (Prisma) - not started
...
## PR 6 - Wire the SQL adapter into `packages/runtime` config - not started

### Discussion

- Expected to be a comparatively mechanical repeat of PR 2's config-selection pattern, applied to the SQL/database choice.
