...
Scaffolded now, work not yet started — this directory exists so the `docs/milestones/` pattern has a second real example, per the [`ui-workspace`](../ui-workspace/MILESTONE.md) milestone's own PR 36.
